...
parser.add_argument("--model", default='bert-large-cased', type=str, help="backbone of encoder.")
parser.add_argument("--train_path", default="data/reward_datasets/openrule_analysis/train.tsv", type=str, help="The path of train set.")
parser.add_argument("--dev_path", default="data/reward_datasets/openrule_analysis/dev.tsv", type=str, help="The path of dev set.")
...
parser.add_argument("--img_log_dir", default='logs/reward_model/openrule_analysis', type=str, help="Logging image path.")
